...
/* ----------------------- Config ----------------------- */
const SIZE_METHOD = 'sqrt';              // 'linear' | 'sqrt' | 'log' | 'loglog'
const SIZE_RANGE = [0.08, 5.0];         // sprite world-size after view scale
...
function makeCircleTexture(fillStyle = "#bbb", size = 128, strokeWidth = 3) {
